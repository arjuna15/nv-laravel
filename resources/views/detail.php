<?php 
    ...
    $kolam_villa = json_decode($dataVilla->kolam_villa, true);
    ?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-md-6">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Luas & Kedalaman Kolam: <?php echo $dataVilla->luas_kolam_villa?> M &nbsp; <?php echo $dataVilla->kedalaman_kolam?> M</li>  
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="room-detail_amenities">
                                        <div class="row">
                                            <div class="col-xs-12 col-md-12">
                                                ...
                                                <ul>
                                                    <li>Penanggung jawab penyewa villa Wajib memberikan KTP/KARTU INDENTITAS kepada staf villa.</li>
                                                    <li>Anak di atas 7 tahun sudah terhitung 1 orang / pax.</li>
                                                    <li>Lebih dari kapasitas max orang, akan di kenakan charge 50.000/org.</li>
                                                    ...
                                                    <li>Dilarang merokok di dalam villa ataupun di dalam kamar, terkecuali di ruangan tertentu yang sudah tersedia asbak, apabila di langgar maka akan di kenakan denda 1.000.000</li>
                                                    <li>Dilarang merubah posisi barang-barang villa, ketika merubah akan di kenakan denda 1.000.000.</li>
                                                    <li>Dilarang membuang sampah dan puntung rokok sembarangan, ketika di langgar maka akan di kenakan denda 200.000.</li>
                                                    <li>Dilarang keras menyalakan hand flare, jika di langgar akan dikenakan denda 1.000.000.</li>
                                                    ...
                                                    <li>Kerusakan billiard akan di kenakan denda ( laken sobek 1.000.000, stik billiard patah/pecah 300.000, segitiga billiard patah/pecah 200.000, bola billiard hilang 250.000 ).</li>
                                                    <li>Dilarang duduk atau menyimpan barang di atas meja billiard, ketika melanggar akan di kenakan denda 1.000.000.</li>
                                                    <li>Ketika villa berantakan berlebihan, contoh ( muntahan, sampah berserakan, tanah, makanan ataupun barang lainnya ) maka akan di denda 500.000.</li>
                                                    <li>Peraturan Kolam Renang ( dilarang makan di kolam renang, dilarang menggunakan shampo & sabun di kolam renang, dilarang memasukan benda apapun kedalam kolam renang ) ketika peraturan tersebut di langgar maka akan di kenakan denda 1.500.000.</li>
                                                    <li>Untuk Villa yang masuk Bus, dikenakan biaya charge 200.000 - 300.000 tergantung wilayah setiap Villanya.</li>
                                                    <li>Management villa tidak bertanggung jawab atas kehilangan properti penyewa villa.</li>
                                                    <li>Penyewa dilarang menggunakan villa untuk tempat asusila atau yang bertentangan dengan peraturan dan ketentuan perundang-undangan yang berlaku di negara indonesia : bermain judi / kegiatan pencucian uang / membawa / menggunakan / mengedarkan obat-obatan terlarang Napza ( narkotika,psikotropika dan zat adiktif lainnya ) dan alcohol / membawa senjata tajam ( apapun jenisnya )/ melakukan kegiatan pornografi dan pornoaksi atau kegiatan yang melanggar UU.ITE dan cybercrime</li>
                                                    <br>
                                                    <h6><b>* NOTED</b> ( untuk villa tertentu ada peraturan - peraturan tambahan yang wajib di patuhi )</h6>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="margin-top:50px">
                                <div class="room_item-1">
                                    ...
                                    <div class="img">
                                        <a href="<?= base_url('/user/detail/1/villa-kamela')?>"><img src="<?=base_url('images/kamela_1.png');?>" alt=""></a>
                                    </div>
                            ...
                            <div class="col-md-4" style="margin-top:50px">
                                <div class="room_item-1">
                                    ...
                                    <div class="img">
                                        <a href="<?= base_url('/user/detail/9/villa-kamela-2')?>"><img src="<?=base_url('images/kamela2_1.png');?>" alt=""></a>
                                    </div>
                                    ...
                                    <div class="bot">
                                        <a href="<?= base_url('user/detail/2'); ?>" class="awe-btn awe-btn-13">SELENGKAPNYA</a>
                                    </div>
                                <br>
                                </div>
                            </div>
                            <div class="col-md-4" style="margin-top:50px">
                                <div class="room_item-1">
                                    ...
                                    <div class="img">
                                        <a href="<?= base_url('/user/detail/3/villa-demang')?>"><img src="<?=base_url('images/clover1.png');?>" alt=""></a>
                                    </div>
